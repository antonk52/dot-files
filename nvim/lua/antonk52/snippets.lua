...
switch (${1:condition}) {
    ...
    ["con"] = [[console.log(${1:logme})]];

    ["iif"] = snippets.u.match_indentation([[
/* istanbul ignore file */
    ]]);

    ["iin"] = snippets.u.match_indentation([[
/* istanbul ignore next */
    ...
    ["import"] = snippets.u.match_indentation([[
