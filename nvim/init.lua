...
usercmd('NoteToday', '=vim.cmd.edit(vim.env.NOTES_PATH .. os.date("/%Y/%m.md"))', { nargs = 0 })
usercmd('ColorLight', 'set background=light | color default', { nargs = 0 })
usercmd('ColorDark', 'set background=dark | color lake', { nargs = 0 })
usercmd('ColorDarkContrast', 'set background=dark | color lake_contrast', { nargs = 0 })
